...
\begin{enumerate}
  ...
  \item \textbf{Loss function}: Binary Cross-Entropy (BCE), Asymmetric Loss (ASL)~\cite{ridnik2021asl}, and Focal Loss~\cite{lin2017focal}.
  \item \textbf{Optimizer}: Adam versus AdamW~\cite{loshchilov2019adamw}.
\end{enumerate}
...
This paper reports results from ten experimental configurations, identifies the best-performing models under both AUC-oriented and Recall/F1-oriented objectives, and provides qualitative interpretability analysis via Grad-CAM~\cite{selvaraju2017gradcam}.
